...
try {
    ...
    $results = $query->select(['Id', 'UrlExterna', 'PathImg', 'TextImportant', 'ClicksPublicidad', 'Estatus', 'Cliente'])
        ->find();
    ...
    $posts = array_map(function ($post) {
        return [
            'Id' => $post['Id'],
            'UrlExterna' => $post['UrlExterna'],
            'PathImg' => $post['PathImg'],
            'TextImportant' => $post['TextImportant'],
            'ClicksPublicidad' => $post['ClicksPublicidad'],
