...
<head>
   ...
   <script src="js/call-post-mexico.js"></script>
   ...
   <div class="page-container">
      <div class="content-wrap">
         ...
         <div class="cover-category">
            <img src="assets/bmexico.jpg" class="img-cover-cat-mex">
         </div>

         <div class="container" id="container-post-cat-mexico">
         </div>

         <div class="container text-center" id="container-load-more-mexico">
            <button type="button" onclick="getNextPostMexico()" class="btn btn-primary" id="load-more-mexico">Cargar más</button>
         </div>
