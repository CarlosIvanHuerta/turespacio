...
const getPostCategoryToDo = () => {
   const params = new URLSearchParams({
      stage: 'categoryToDo',
      tax_slut: CATEGORY_SLUT_POST.POST_QUE_HACER,
      tax_name: CATEGORY_NAME_POST.POST_QUE_HACER,
      tax_id: CATEGORY_TERM_ID_POST.POST_QUE_HACER,
      limit: 6
   });
...
const renderPostCategoryToDo = (data) => {
   try {

      const container = document.querySelector('#container-post-cat-que-hacer')
      //container.innerHTML = ''
