...
const getPostCategoryMexico = () => {
   const params = new URLSearchParams({
      stage: 'categoryMexico',
      tax_slut: CATEGORY_SLUT_POST.POST_MEXICO,
      tax_name: CATEGORY_NAME_POST.POST_MEXICO,
      tax_id: CATEGORY_TERM_ID_POST.POST_MEXICO,
      limit: 6
   });
...
const renderPostCategoryMexico = (data) => {
   try {

      const container = document.querySelector('#container-post-cat-mexico')
      //container.innerHTML = ''
...
const renderNextPostMexico = (data) => {
   try {
