...
<head>
   ...
   <script src="js/call-post-el-mundo.js"></script>
   ...
   <div class="page-container">
      <div class="content-wrap">
         ...
         <div class="cover-category">
            <img src="assets/belmundo.jpg" class="img-cover-cat-mundo">
         </div>

         <div class="container" id="container-post-cat-mundo">
         </div>

         <div class="container text-center" id="container-load-more-mexico">
            <button type="button" onclick="getNextPostWorld()" class="btn btn-primary" id="load-more-mexico">Cargar más</button>
         </div>
